...
const swaggerOptions = {
    ...
    customCssUrl: '/customSwaggerCss.css'
}
...
app.get("/customSwaggerjs.js", (req, res)=>{
    res.sendFile(__dirname + '/customSwaggerjs.js')
})
app.get("/customSwaggerCss.css", (req, res)=>{
    res.sendFile(__dirname + '/customSwaggerCss.css')
})
...
const { options } = require("./routes/students")
